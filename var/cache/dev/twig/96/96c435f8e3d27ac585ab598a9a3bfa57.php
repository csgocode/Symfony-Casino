...
/* gaming/sheila.html.twig */
class __TwigTemplate_cc76b9a0f5538ed0e269ed3e54632c34 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "gaming/sheila.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "gaming/sheila.html.twig"));
...
<body>
    ...
    <!-- inner banner start -->
    <section class=\"banner-section inner-banner about how-works\">
        <div class=\"banner-content position-relative d-flex align-items-center\">
            <div class=\"container\">
                <div class=\"row d-flex justify-content-start\">
                    <div class=\"col-md-6\">
                        <div class=\"text-area\">
                            <h2>Rescata a Sheila</h2>
                            <div class=\"breadcrumb-area\">
                                <nav aria-label=\"breadcrumb\">
                                    <ol class=\"breadcrumb d-flex gap-2 gap-lg-0 mt-2 mt-lg-0\">
                                        <li class=\"breadcrumb-item\"><a href=\"index.html\">Inicio</a></li>
                                        <li class=\"breadcrumb-item\"><a href=\"javascript:void(0)\">Juegos</a></li>
                                        <li class=\"breadcrumb-item active\" aria-current=\"page\">Rescata a Sheila</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class=\"col-md-6\">
                        <div class=\"illus-area d-none d-md-block position-absolute bottom-0\">
                            <img src=\"/assets/images/banner-how-works-illus.png\" class=\"wow fadeInUp\" alt=\"icon\">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <style>
        ...
        #bird {
            ...
            height: 24px;
            position: absolute;
            background-color: #FFD700; /* Representa el pájaro con un color sólido */
        }
        .pipe {
            position: absolute;
            width: 52px;
    ...
    <!-- How to Play start -->
    <section class=\"how-play index-2\">
        <div class=\"container pb-120\">
            <div class=\"row bg-area position-relative overflow-hidden justify-content-end align-items-center\">
                <div class=\"col-lg-9\">
                    <div class=\"main-content mt-60 mb-60\">
                        <div class=\"abs-area\">
                            <img src=\"/assets/images/how-play-illus.png\" alt=\"image\">
                        </div>
                ...
                <div class=\"row d-flex justify-content-center\">
                    <div class=\"col-lg-6\">
                        <div class=\"section-header text-center\">
                            ...
                            <p class=\"w-75 m-auto\">Do you have a question about Dooplo? Please <a href=\"javascript:void(0)\">contact us</a>! We would love to answer your questions.</p>
                        </div>
                    </div>
                </div>
                <div class=\"row d-flex justify-content-center\">
                                ...
                                <div class=\"accordion-item\">
                                    <h5 class=\"accordion-header\" id=\"headingTwo\">
                                        <button class=\"accordion-button collapsed\" type=\"button\"
                                            ...
                                            Is Dooplo available on Mac/mobile/console?
                                        </button>
                                    </h5>
                                ...
                                <div class=\"accordion-item\">
                                    <h5 class=\"accordion-header\" id=\"headingThree\">
                                        <button class=\"accordion-button collapsed\" type=\"button\"
                                            ...
                                            I’m not a high-level player. Can I still use Dooplo?
                                        </button>
                                    </h5>
    ...
    <script src=\"/assets/js/sheila.js\"></script> <!-- Asegúrate de reemplazar esto con la ruta correcta a tu script de JS -->
</body>
    ...
    {
        return "gaming/sheila.html.twig";
    }
...
</html>", "gaming/sheila.html.twig", "/home/alumno/Symf/CasinoV2/templates/gaming/sheila.html.twig");
    }
}
