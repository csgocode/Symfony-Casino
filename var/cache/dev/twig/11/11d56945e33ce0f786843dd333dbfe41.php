            ...
            <div class=\"row justify-content-between\">
                <div class=\"col-xl-6 col-lg-6\">
                    <div class=\"section-text\">
                        ...
                        <p>In Dooplo, you can participate in online duels and tournaments for the games you like to start winning big prize money.</p>
                    </div>
                    <div class=\"dooplo-info cus-mar\">
                        ...
                        <div class=\"single-box d-flex gap-3 align-items-center\">
                            <div class=\"icon-area d-center\">
                                <img src=\"assets/images/icon/info-icon-3.png\" alt=\"icon\">
                            </div>
                            <div class=\"text-area\">
                                <h5>Win Rewards</h5>
                                <p>Win real money.</p>
                ...
                <div class=\"col-xl-5 col-lg-6 mt-5 mt-lg-0\">
                    <div class=\"form-content\">
                        ";
        // line 231
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formulario"]) || array_key_exists("formulario", $context) ? $context["formulario"] : (function () { throw new RuntimeError('Variable "formulario" does not exist.', 231, $this->source); })()), 'form');
        echo "
                    </div>
                </div>
            </div>
